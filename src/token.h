...
typedef enum {
    ...
    TOKEN_PIPE, TOKEN_AND, TOKEN_LANGLE, TOKEN_RANGLE, TOKEN_EQUAL, TOKEN_COMMA, TOKEN_AT, 
    TOKEN_HASH, TOKEN_CARET, TOKEN_DOLLAR, TOKEN_TILDE, TOKEN_QMARK, TOKEN_USCORE, TOKEN_COLON,
    // adverbs
